	...
	void OnGUI(){
        ...
        if (toolbarInt == 0)
        {
            ...
            for (int i = 0; i < rulelis.Count; i++)
            {
                ...
                GUI.Label(new Rect(75, 110 + (30 * (i + 1)), 100, 20), rulelis[i]);
                GUI.Label(new Rect(Screen.width/3, 110 + (30 * (i + 1)), 100, 20), rulelis[i]);
                GUI.Label(new Rect(Screen.width - (Screen.width / 3), 110 + (30 * (i + 1)), 100, 20), rulelis[i]);
                GUI.Label(new Rect(Screen.width - 115, 110 + (30 * (i + 1)), 100, 20), rulelis[i]);
        ...
        if (toolbarInt == 1)
        {
            ...
            GUI.DrawTexture(new Rect(80, 80, 100, 100),rulepic[boon], ScaleMode.StretchToFill, true, 10.0F);
            GUI.Label(new Rect(Screen.width / 2 - 50 , 100 , 100 , 20), rulelis[boon]);
